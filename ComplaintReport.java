...
import javax.swing.*;
import java.sql.*;
class ComplaintReport extends JFrame implements ItemListener,ActionListener
{
...
l1=new JLabel("Complaint Report:");
l1.setFont(f1);
...
l3=new JLabel("Select Complaint Id:");
...
public void itemStateChanged(ItemEvent ae)
{
 try{
	...
	doConnect();
	String sql="select * from Complaint_Table where Complaint_Id="+sid+"";
	rs=stmt.executeQuery(sql);
	final String[] cols={"CID","MNAME","CTYPE","CDESCRIPTIONS"};
