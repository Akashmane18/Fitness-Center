...
try{	if(ae.getSource()==b1)
	...
	mgender="Female";
		...
		Connection con=DriverManager.getConnection("jdbc:odbc:Fitness");
		System.out.println("Connection Established");
		Statement stmt=con.createStatement();
		String sql="insert into Registration_Table values ("+ eid + "," + mid + ",'" + mname + "','" +maddr +"','" + memail+ "','" +mgender+"','"+mtype+"'," + mage +",'"+mdesc+"')";
