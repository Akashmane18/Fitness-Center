...
import javax.swing.*;
import java.sql.*;
class RegistrationReport extends JFrame implements ItemListener,ActionListener
{
...
l3=new JLabel("Select member Id:");
...
public void itemStateChanged(ItemEvent ae)
{
 try{
	...
	doConnect();
	String sql="select * from Registration_Table where M_ID="+sid+"";
	rs=stmt.executeQuery(sql);
	final String[] cols={"MID","MNAME","MADDRESS","MEMAIL"};
