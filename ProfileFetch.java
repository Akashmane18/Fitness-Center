...
public class ProfileFetch extends JFrame implements ItemListener
{
	...
	JButton b1,b2; 	
     	...
     	Font f3=new Font("Old English Text MT",Font.BOLD,30);
	ResultSet rs;
  	Container c;
                   Connection cn;
                   Statement s;
  ...
  c1.setBounds(250,40,150,30);
	//jcombo box 
      ...
      c1.addItemListener(this);
         ...
         l4=new JLabel("Member BMI[kg/ft]");
         ...
         l5=new JLabel("Member Certification:");
...
public void itemStateChanged(ItemEvent ae)
{
    ...
    System.out.println("Driver Loaded\n"); 
   s=cn.createStatement();
   str="select * from Profile_Table where P_Id="+mid+"";
     rs=s.executeQuery(str);
...
while(rs.next())
{
	...
	t2.setText(rs.getString(2));
    	...
    	t4.setText(rs.getString(11));
    	t5.setText(rs.getString(19));
