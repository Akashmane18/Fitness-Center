...
public class FeesFetch extends JFrame implements ItemListener
{
	...
	public FeesFetch()
     	{ 
        		img1=new ImageIcon("E:/Java/jdk1.5.0/bin/Fitness Center/images/body.jpg");
         		setSize(1500,900);
         		setLayout(null);
         		setVisible(true);
         		show();
...
public void itemStateChanged(ItemEvent ae)
{
    ...
    System.out.println("Driver Loaded\n"); 
   s=cn.createStatement();
   str="select * from Fees_Table where Fees_Id="+mid+"";
     rs=s.executeQuery(str);
