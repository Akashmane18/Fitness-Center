...
public class TrainerFetch extends JFrame implements ItemListener
{
	...
	JButton b1,b2; 	
     	...
     	Font f3=new Font("Seven Monkey Fury BB",Font.BOLD,30);
  ...
  c1.setBounds(250,40,150,30);
	//jcombo box 
      ...
      c1.addItemListener(this);
         ...
         l4=new JLabel("Skills and Certifications");
         ...
         l5=new JLabel("Trainer Email Id:");
...
public void itemStateChanged(ItemEvent ae)
{
    ...
    System.out.println("Driver Loaded\n"); 
   s=cn.createStatement();
   str="select * from Trainer_Table where Trainer_Id="+mid+"";
     rs=s.executeQuery(str);
