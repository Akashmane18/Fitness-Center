...
public class ReceiptFetch extends JFrame implements ItemListener
{
	...
	//jcombo box 
      ...
      c1.addItemListener(this);
        ...
        //p5.add(b2);
          ...
          l6=new JLabel("Fees Receipt Details");
...
public void itemStateChanged(ItemEvent ae)
{
    ...
    System.out.println("Driver Loaded\n"); 
   s=cn.createStatement();
   str="select * from Receipt_Table where Receipt_Id="+mid+"";
     rs=s.executeQuery(str);
