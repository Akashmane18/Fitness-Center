...
public class CustSearch extends JFrame implements ItemListener
{
	...
	JButton b1,b2; 	
     	...
     	Font f3=new Font("Lucida Handwriting",Font.BOLD,30);
	ResultSet rs;
  	Container c;
                   Connection cn;
                   Statement s;
	String str="";
	 int cid;
  	String cname,cadd,contact,emid;
  ...
  c1.setBounds(250,40,150,30);
	//jcombo box 
		 try
    		...
    		cn=DriverManager.getConnection("Jdbc:Odbc:snehal");
      ...
      c1.addItemListener(this);
         ...
         l5=new JLabel("Customer Email Id:");
...
public void itemStateChanged(ItemEvent ae)
{
    ...
    cid=Integer.parseInt((String)ae.getItem());
    cname=t2.getText();
    ...
    System.out.println("Driver Loaded\n"); 
   s=cn.createStatement();
   str="select * from customer where cid="+cid+"";
     rs=s.executeQuery(str);
while(rs.next())
{
