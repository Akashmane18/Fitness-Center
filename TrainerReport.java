...
import javax.swing.*;
import java.sql.*;
class TrainerReport extends JFrame implements ItemListener,ActionListener
{
...
ResultSet rs;
JScrollPane JSP;
Font f1=new Font("Seven Monkey Fury BB",Font.BOLD,45);
...
l3=new JLabel("Select Trainer Id:");
...
public void itemStateChanged(ItemEvent ae)
{
 try{
	...
	rs=stmt.executeQuery(sql);
	final String[] cols={"TID","TNAME","TSHIFT","TCERTIFICATIONS"};
