...
public class ComplaintFetch extends JFrame implements ItemListener
{
	...
	JButton b1,b2; 	
      ...
      Font f4=new Font("Living by Numbers",Font.BOLD,30);
	...
	//jcombo box 
		 try
   		...
   		s=cn.createStatement();
  			 str="select * from Complaint_Table";
      ...
      c1.addItemListener(this);
        ...
        p5.add(b2);
          ...
          l6=new JLabel("Complaint Details");
         l6.setForeground(Color.black);
         l6.setFont(f7);
         //l6.setBounds(400,110,500,50);
       l6.setBounds(400,10,500,50);
...
public void itemStateChanged(ItemEvent ae)
{
    ...
    System.out.println("Driver Loaded\n"); 
   s=cn.createStatement();
   str="select * from Complaint_Table where Complaint_Id="+mid+"";
     rs=s.executeQuery(str);
