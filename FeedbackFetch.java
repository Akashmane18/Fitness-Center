...
public class FeedbackFetch extends JFrame implements ItemListener
{
  ...
  c1.setBounds(250,40,150,30);
	//jcombo box 
      ...
      c1.addItemListener(this);
         ...
         l5=new JLabel("Complaint Status");
        ...
        //p5.add(b2);
          ...
          l6=new JLabel("Feedback Details");
...
public void itemStateChanged(ItemEvent ae)
{
    ...
    System.out.println("Driver Loaded\n"); 
   s=cn.createStatement();
   str="select * from Feedback_Table where Feedback_Id="+mid+"";
     rs=s.executeQuery(str);
