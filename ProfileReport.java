...
import javax.swing.*;
import java.sql.*;
class ProfileReport extends JFrame implements ItemListener,ActionListener
{
...
l3=new JLabel("Select Profile Id:");
...
public void itemStateChanged(ItemEvent ae)
{
 try{
	...
	doConnect();
	String sql="select * from Profile_Table where P_Id="+sid+"";
	rs=stmt.executeQuery(sql);
	final String[] cols={"PID","MNAME","BMI","MDISEASE"};
